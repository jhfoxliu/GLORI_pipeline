				...
				for pileupread in pileupcolumn.pileups:
					if pileupread.query_position is not None and pileupread.alignment.query_qualities[pileupread.query_position] >= options.qual:
						...
						if not_at_end == True:
							...
							if pileupread.alignment.get_tag("YG") == "A2G":	
								C_segment = pileupread.alignment.query_sequence.count('A')
							...
							elif pileupread.alignment.get_tag("YG") == "T2C":
								C_segment = pileupread.alignment.query_sequence.count('T')
